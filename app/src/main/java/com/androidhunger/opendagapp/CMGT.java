...
//Activity that shows the specific information about CMGT, with links to share, more info, a map and add to calender //
    ...
    public void goToPopUp3(View v) {
        Intent a = new Intent(this, popplattegrondenCMGT.class);
        startActivity(a);
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
    }
