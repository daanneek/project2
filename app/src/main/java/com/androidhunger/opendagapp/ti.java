...
//Activity that shows the specific information about Technische informatica, with links to share, more info, a map and add to calender //
    ...
    public void goToPopUp5(View v) {
        Intent a = new Intent(this, popplattegrondenTechnischeInformatica.class);
        startActivity(a);
        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
    }
